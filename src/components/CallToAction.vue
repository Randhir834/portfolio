<template>
  <section class="py-20 bg-gradient-to-r from-primary via-blue-600 to-indigo-700 text-white relative overflow-hidden">
    ...
    <div class="absolute inset-0 opacity-10">
      ...
      <div class="absolute bottom-10 left-1/2 w-72 h-72 bg-indigo-300 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-4000"></div>
    </div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
      ...
      <!-- Social Links -->
      <div class="mt-12">
        <p class="text-blue-100 mb-4">Or connect with me on</p>
        <div class="flex justify-center gap-6">
          <a 
            ...
            class="w-12 h-12 bg-white bg-opacity-20 rounded-full flex items-center justify-center hover:bg-opacity-30 transition-all duration-300 transform hover:scale-110"
...
export default {
  ...
  setup() {
    const socialLinks = ref([
      {
        name: 'GitHub',
        url: 'https://github.com/Randhir834',
      ...
      {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/randhir-kumar-4b4ab321a/',
        icon: 'M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z'
      },
      {
        name: 'LeetCode',
        url: 'https://leetcode.com/u/randhirkumar/',
      ...
      {
        name: 'Email',
        url: 'mailto:randhir.grd1122@gmail.com',
